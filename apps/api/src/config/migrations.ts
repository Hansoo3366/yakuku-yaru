...
export async function runMigrations() {
  ...
  await db.execute(
    `DELETE g
     FROM games g
     WHERE g.external_source IS NULL
       AND g.ticket_url = 'https://www.ticketlink.co.kr/sports/baseball'
       AND (g.game_date, g.home_team_id, g.away_team_id) IN (
         ('2026-06-02 18:30:00', 1, 5),
         ('2026-06-03 18:30:00', 1, 5),
         ('2026-06-04 18:30:00', 1, 5),
         ('2026-06-05 18:30:00', 9, 6),
         ('2026-06-06 17:00:00', 7, 2),
         ('2026-06-07 14:00:00', 3, 8),
         ('2026-06-11 18:30:00', 5, 10),
         ('2026-06-13 17:00:00', 6, 4),
         ('2026-06-14 14:00:00', 10, 1),
         ('2026-06-20 17:00:00', 8, 7),
         ('2026-06-21 14:00:00', 2, 3)
       )
       AND NOT EXISTS (
         SELECT 1
